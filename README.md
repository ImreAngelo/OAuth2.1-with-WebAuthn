...
<details>
  ...
  <ol>
    ...
    <li><a href="#oauth-2.1-protocol">OAuth 2.1 Protocol</a></li>
    <li><a href="#webauthn">WebAuthn</a></li>
    <li><a href="#automatic-key-rotation">Automatic Key Rotation</a></li>
...
Authorization is managed centrally by hashicorp vault. 
